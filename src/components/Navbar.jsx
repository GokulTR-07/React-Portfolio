    ...
    <>
      <div className="flex items-center justify-between py-6 px-8 mb-10">
        ...
        transition={{duration: 1, delay: 0}}
          className="py-4 px-8 rounded-3xl text-center border shadow-lime-200 shadow-2xl hover:bg-lime-300 hover:shadow-lime-300 hover:shadow-2xl">
          <span className="font-medium md:text-4xl text-white hover:text-black ">
            Gokul <span className="text-lime-500 hover:text-white">TR</span>
          </span>
        </motion.div>
